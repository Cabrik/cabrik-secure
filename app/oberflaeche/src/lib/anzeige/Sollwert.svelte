<!--
  Etwas, das der NUTZER verlangt hat — nicht das Programm.
...
<p
  class="text-sollwert border-sollwert/40 inline-flex items-center gap-1.5 rounded border px-2 py-0.5 text-xs"
>
