...
fn art_text(k: FindingKind) -> &'static str {
    match k {
        ...
        FindingKind::CroppedImage => "zugeschnittenes Bild (Original liegt vollständig bei)",
        FindingKind::TrackedChange => "nachverfolgte Änderung (gelöschter Text ist noch da)",
